Generate a diagram of the following functionality. The background should off white. 

The first line should have the  contents of `**{AWF Task Type}**: {AWF Task Name}`. The template name should be in parenthesis on a line below. Pods should be indicated in green, all others in gray.
